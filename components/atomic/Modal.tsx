  ...
  return (
    <>
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as='div' className={`${className} relative`} onClose={onClose}>
          <Transition.Child
            as={Fragment}
          ...
          <div className='fixed inset-0 overflow-y-auto z-10'>
            <div className='flex min-h-screen h-full items-center justify-center text-center'>
              <Transition.Child
                as={Fragment}
                enter='ease-out duration-300'
              ...
              >
                <Dialog.Panel className='w-full max-w-max transform text-left align-middle transition-all lg:fixed lg:inset-y-auto'>
                  <button onClick={onClose}>
                    <svg
                      className='text-base-content absolute top-10 right-5 w-7 h-7'
                      viewBox='0 0 24 24'
                      fill='none'
